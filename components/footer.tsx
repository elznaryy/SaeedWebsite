        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-light/80 hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/#blog" className="text-light/80 hover:text-primary transition-colors">
                  Blog
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-light/80">Cairo, Egypt</li>
              <li>
                <a href="mailto:saeed@example.com" className="text-light/80 hover:text-primary transition-colors">
                  saeed@example.com
                </a>
              </li>
              <li>
                <a href="tel:+11234567890" className="text-light/80 hover:text-primary transition-colors">
                  +1 (123) 456-7890
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-secondary/30 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6 text-sm">
              <li>
                <Link href="/privacy" className="text-light/60 hover:text-primary transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-light/60 hover:text-primary transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
